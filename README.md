...
<li>Interested in model quantization, structured pruning, knowledge distillation, and generative AI</li>
<li>Building AI pipelines that bridge research prototypes and production-level deployment</li>
